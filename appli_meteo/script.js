...
function requestApi(city){
    api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&units=metric&lang=fr&appid=c0f79863e5df796678d1046a15ae25f2"
    fetchData();
}
...
function weatherDetails(info){
    if (info.cod ==="404"){
        ...
        if(id === 800){
            wIcon.src = "Clean.jpeg"
        }else if(id >= 200 && id <= 232){
            wIcon.src = "storm.jpeg";
        }else if(id >= 600 && id <= 622){
            wIcon.src = "OIP.jpeg";
        }else if(id >= 701 && id <= 781){
            wIcon.src = "haze.jpeg";
        }else if(id >= 801 && id <= 804){
            wIcon.src = "Cloudy.jpeg";
